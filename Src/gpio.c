...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED1_Pin|LED2_Pin|MOT_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_Pin LED2_Pin MOT_EN_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED2_Pin|MOT_EN_Pin;
